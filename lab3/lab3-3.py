...
разделенных двоеточием. Например, str[2:5]
"""
...
python = monty_python[-5:]		# Используйте оператор среза для получения подстроки “Python”
print(python)
...
print("Ice" in ice_cream and "ice" in ice_cream)
