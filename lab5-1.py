...
# Напишите логическое выражение со значением "человека зовут
# John или ему 17" с использованием оператора not
...
# True если человека зовут John или ему не более 17 лет
print(name == "John" or not age > 17)

# Напишите логическое выражение, проверяющее следующее высказывание: "Человека зовут не John,
# он старше 20 лет и первая буква его имени не ‘E’".
