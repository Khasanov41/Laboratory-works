"""
Ключевое слово if используется для построения условного оператора, который
выполняет определенный код после проверки некоторого условия (логического выражения) на истинность.
...
if x < 0:
    ...
    # если x < 0 не истина и x != 0 не истина, проверяется равенство x == 1
    print('x == 1')
else:
    # объясните в каком случае выполняется этот оператор?
    print('non of the above is true')

name = "John"

# Выведите True если значение переменной name "John" и False в противном случае
print(True) if name == "John" else print(False)
